...
public class DialogoResponderEnquesta extends JDialog {
    ...
    private String getEmojiTipus(TipusPregunta tp) {
        switch (tp) {
            case NUMERICA: return "🔢";
            case TEXT_LLIURE: return "✏️";
            case QUALITATIVA_ORDENADA:
            case QUALITATIVA_NO_ORDENADA_SIMPLE: return "📋";
            case QUALITATIVA_NO_ORDENADA_MULTIPLE: return "☑️";
            default: return "❓";
        }
    }
    ...
    private String getInstruccions(Pregunta p) {
        switch (p.getTipus()) {
            case NUMERICA: return "Valor entre " + p.getValorMinim() + " i " + p.getValorMaxim();
            case TEXT_LLIURE: return "Text lliure";
            case QUALITATIVA_ORDENADA:
            case QUALITATIVA_NO_ORDENADA_SIMPLE: return "Selecciona una opció";
            case QUALITATIVA_NO_ORDENADA_MULTIPLE: return "Selecciona fins a " + p.getMaxSeleccions() + " opcions";
            default: return "";
        }
    }
